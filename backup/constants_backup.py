...
class Model(str, Enum):
    ...
    QWEN = "ollama/qwen3"
    OLLAMA_LAMA3_1_8B = "ollama/llama3.1",
    OLLAMA_GPT_5_MINI_LOCAL = "ollama/gpt-oss"
    ...
    def _missing_(cls, value):
        if value:
            normalized_value = "".join(
                [x for x in value if x.isalpha()]).lower()
            for member in cls:
                normalized_member = "".join(
                    [x for x in member if x.isalpha()]).lower()
...
DEEPSEEK_R1_DISTILL_QWEN_1_5B_MODEL_CARD = {
    ...
    "usd_per_output_token": 0.18 / 1E6,
    ##### Time #####
    # NOTE: copied to be same as LLAMA3_1_8B_INSTRUCT_MODEL_CARD; need to update when we have data
    "seconds_per_output_token": 0.0050,
    ##### Agg. Benchmark #####
...
CLIP_VIT_B_32_MODEL_CARD = {
    ...
    "usd_per_output_token": None,
    ##### Time #####
    # NOTE: just copying TEXT_EMBEDDING_3_SMALL_MODEL_CARD for now
    "seconds_per_output_token": 0.0098,
    ##### Agg. Benchmark #####
...
MODEL_CARDS = {
    ...
    Model.QWEN.value: LLAMA3_1_8B_INSTRUCT_MODEL_CARD,
    Model.OLLAMA_LAMA3_1_8B.value: LLAMA3_1_8B_INSTRUCT_MODEL_CARD,
    Model.OLLAMA_GPT_5_MINI_LOCAL.value: GPT_5_MINI_MODEL_CARD
}
